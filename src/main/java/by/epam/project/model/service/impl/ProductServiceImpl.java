...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public AjaxData updateProductInfo(String idString, String name, String info, String priceString, String countString) throws ServiceException {
        AjaxData ajaxData = new AjaxData();
    ...
    public AjaxData createProduct(String idCategoryString, String name, String info,
        ...
        try {
            ...
            Product product = new Product(name, info, Product.Status.INACTIVE, price);
