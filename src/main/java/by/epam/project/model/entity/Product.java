...
public class Product {
     ...
     */
    public Product(long id, String name, String info, Status status, BigDecimal price, String imageURL, Integer count) {
        this.id = id;
        this.name = name;
        this.info = info;
        this.status = status;
    ...
    public boolean equals(Object o) {
        ...
        if (count != null ? !count.equals(user.count) : user.count != null) {
            return false;
        }
        return true;
    }
