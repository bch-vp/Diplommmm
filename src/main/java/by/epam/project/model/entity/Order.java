...
public class Order {
     ...
     */
    public Order(long id, String comment, String address, java.sql.Date dateCreatedAt, BigDecimal totalPrice, Status status) {
        this.id = id;
     ...
     * @param totalPrice the total price
     */
    public Order(long id, String comment, String address, java.sql.Date createdAt, BigDecimal totalPrice) {
        this.id = id;
        this.comment = comment;
        this.address = address;
     ...
     * @param totalPrice the total price
     */
    public Order(String comment, String address, java.sql.Date createdAt, BigDecimal totalPrice) {
        this.comment = comment;
        this.address = address;
        this.dateCreatedAt = createdAt;
        this.totalPrice = totalPrice;
     ...
     * @param status     the status
     */
    public Order(String comment, String address, java.sql.Date createdAt, BigDecimal totalPrice, Status status) {
        this.comment = comment;
        this.address = address;
        this.dateCreatedAt = createdAt;
        this.totalPrice = totalPrice;
     ...
     * @param createdAt the created at
     */
    public Order(String comment, String address, java.sql.Date createdAt) {
        this.comment = comment;
        this.address = address;
        this.dateCreatedAt = createdAt;
    }
     ...
     * @param status    the status
     */
    public Order(String comment, String address, java.sql.Date createdAt, Status status) {
        this.comment = comment;
        this.address = address;
        this.dateCreatedAt = createdAt;
        this.status = status;
